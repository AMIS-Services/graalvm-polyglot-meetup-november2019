...
console.log("Fibonacci(9) - called from JS, executed in Python "+fibFunc(9))

var title = Polyglot.eval("python", "title")
console.log ("Title retrieved from Python: "+ title)
...
var x = 5
console.log(`Square of ${x} = ${square(x)} - according to Python`)
